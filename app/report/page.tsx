      ...
      {loading ? (
        ...
        <div className="border border-line rounded-lg divide-y divide-line bg-white/50 overflow-hidden">
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-ink/50">
                    ...
                    {scostamento !== null && (
                      <span className={scostamento > 0 ? ' text-danger font-medium' : ' text-teal font-medium'}>
                        {' '}
                        ({scostamento > 0 ? '+' : ''}
          ...
          {commesseChiuse.length === 0 && (
            <p className="px-4 py-8 text-sm text-ink/50 text-center">Nessuna commessa chiusa ancora.</p>
          )}
        </div>
      )}
    </div>
